...
class Calculator:
    def __init__(self, master):
        ...
        self.display = tk.Entry(master,bd = 29,justify="right",bg = "powder blue", width=25, font=('Arial', 16))
        ...
        col = 0
        for digit in digits:
            tk.Button(master,bd = 8, text=digit, width=5, height=2,
        ...
        for operator in operators:
            tk.Button(master,bd = 8, text=operator, width=5, height=2,
